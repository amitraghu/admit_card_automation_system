...
function go(){
    ...
    <body>
        ...
        <div id="nbody2">
            <center><br>
                <h2>Add Course</h2><br>
                <form class="form-group" name="f2" action="add_course.jsp" method="post">
            <table>
                <tr><td>C_ID  :</td><td><input class="form-control" type="text" name="cid" style="height:30px;width:250px"/></td></tr>
                <tr><td>  </td><td>  </td></tr>
                <tr><td>C_Name :</td><td><input class="form-control" type="text" name="cn" style="height:30px;width:250px"/></td></tr>
            </table><br>
