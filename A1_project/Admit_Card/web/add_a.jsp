<%-- 
    Document   : add_a
    Created on : Mar 26, 2018, 5:39:48 PM
    Author     : Deepti
--%>
...
function go(){
    ...
    <body>
        ...
        <div id="nbody2">
            <center><br>
                <h2>Add Admin</h2><br>
            <form class="form-group" name="f2" action="add_admin.jsp" method="post">
                <table>
                <tr><td>A_ID  :</td><td><input class="form-control" type="text" name="ai" style="height:40px;width:250px"/></td></tr>
       <tr><td> A_Name :</td><td><input type="text" class="form-control" name="an" style="height:40px;width:250px"/></td></tr>
       <tr><td> A_Password :</td><td><input type="password" class="form-control" name="ap" style="height:40px;width:250px"/></td></tr>
            </table><br>
