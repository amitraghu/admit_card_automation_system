       ...
       <table>
        ...
        <br>
         <center>
            ...
            ResultSet rs=st.executeQuery("select * from subject where Flag=1");
        %>
        <center>
            <div id='n3'>
            ...
            <%
             ...
             <tr>
                 ...
                 <td><a href="delete_sub.jsp?sub_id=<%=rs.getString(1)%>" onclick="return confirm('Are you sure you want to delete?')"><img src="del1.png"</a></td>
                 <td><a href="update_sub.jsp?sub_id=<%=rs.getString(1)%>&sub_name=<%=rs.getString(2)%>&type=<%=rs.getString(3)%>"><img src="edit1.png"></a></td>
             </tr>
             <% } 
             %> 
            </table>
            </div>
            <p>&nbsp;<strong>D</strong>-Disciplinary Paper&nbsp;&nbsp;
               <strong>P</strong>-Practical Paper&nbsp;&nbsp;
               <strong>F</strong>-Foundational Paper</p><br>
        <%  
                   rs.close();
                st.close();
                con.close();
                ...
                %>
                <form method="get">
       <input type="submit" name="add" VALUE="Add" formaction="add_sub.jsp" class="btn btn-primary" style="height:30px;width:150px"/>&nbsp;&nbsp;
