    ...
    <body>
        ...
        <center>
            ...
            <%
             ...
             <tr>
                 ...
                 <td><a href="del_v.jsp?uid=<%=rs.getString(1)%>" onclick="return confirm('Are you sure you want to delete?')"><img src="del1.png"</a></td>
                 <td><a href="edit_v.jsp?uid=<%=rs.getString(1)%>&uname=<%=rs.getString(2)%>&pid=<%=rs.getString(1)%>"><img src="edit1.png"></a></td>
             </tr>
             <% } 
             %>
            </table><br><br>
        <%  
                ...
                <form method="get" action="add_v.jsp">
                    <button type="submit" class="btn btn-primary" style="height:30px;width:150px">Add</button>
